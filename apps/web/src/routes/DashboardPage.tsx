...
const liveModules = [
  ...
  { title: "Auto-apply", description: "Configure rules for automatic applications.", to: "/auto-apply" },
];
...
export function DashboardPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <p className="mt-1 text-sm text-slate-500">Everything you need to go from resume to offer, in one place.</p>
